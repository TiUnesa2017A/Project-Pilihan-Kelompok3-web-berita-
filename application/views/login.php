...
<html >
    ...
    <body style="background-color: #296ad1;">
<style type="text/css">
.error{
    ...
    <div class="off-canvas-wrap" data-offcanvas="">
        <div class="inner-wrap">
            ...
            <section class="full-page-section" id="loginSection" style="height: 599px;">
                <div class="inner">
                    <div class="row">
                        <div class="medium-6 medium-offset-3 columns" style="background-color: grey; border-radius: 10px;">
                            <div class="row">
		...
		<div class="medium-8 columns">
			...
			<button type="submit" name="login" class="button" style="background-color: #4286f4; border-width: 0px;">Login</button>
			</div>
